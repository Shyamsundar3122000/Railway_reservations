                    ...
                    <Row style={{ alignItems: 'center', justifyContent: 'center', margin: 30 }}>
                        <Col>
                            <div id="page">
                                ...
                                <p><strong>Telephones : </strong>+91 982 476 1956 <br /><strong>Fax Nos : </strong>+91 112 446 4390<br /><strong>Email : </strong>
                                    <a href="mailto:shyamsundarvirat18@gmail.com">IRCTC@railway.gov.lk</a>
                                    <span style={{ display: 'none' }}>This e-mail address is being protected from spambots. You need JavaScript enabled to view it
                                        </span>
                                </p>
                                <p><strong>Railway Head Office Exchange Number</strong> : +91 112 421 2681</p>
                                <p><strong>Fort Railway Station Inquiries</strong> : +91 112 434 2715</p>
                                <p><strong>Deputy Operating Superintendent</strong> : +91 112 687 1099</p>
                                <p className="MsoNormal"><strong>Assistant Transportation Superintendent (Operation)</strong> : +91 112 692 9286</p>
                            </div>
                        </Col>
                    </Row>
                </Col>
